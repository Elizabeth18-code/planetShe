    ...
    <>
      ...
      >
        <div className="relative z-10 max-w-2xl mx-auto space-y-4">
          ...
          <p className="text-gray-500 text-lg">
            Artigos sobre identidade, autoestima, valores e relacionamentos.
          </p>
        </div>
      </section>
      ...
      <section className="py-8 px-8 border-b border-gray-100">
        <div className="max-w-7xl mx-auto flex items-center gap-3 flex-wrap">
          {categorias.map((cat) => (
            <button key={cat} className="px-4 py-2 rounded-full text-sm font-semibold bg-gray-100 text-gray-600 hover:bg-pink-100 hover:text-pink-600 transition-all duration-200">
              {cat}
            </button>
          ))}
        </div>
