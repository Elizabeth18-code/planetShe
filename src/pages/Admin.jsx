...
function firebaseErr(e) {
  ...
  if (code === "permission-denied") {
    return "Sem permissão para ler as histórias. Publica as regras do ficheiro firestore.rules e confirma que o teu UID está em admin_users com active: true.";
  }
    ...
    return (
      <main className="pt-28 pb-16 px-4 min-h-screen">
        <div className="max-w-xl mx-auto space-y-4 text-gray-600">
          <h2 className="text-xl font-bold text-gray-900">Firebase não configurado</h2>
          <p>
            Cria o ficheiro <code className="bg-gray-100 px-1 rounded">.env</code> na raiz do projeto
            e preenche as variáveis <code className="bg-gray-100 px-1 rounded">VITE_FIREBASE_*</code>.
          </p>
          <ol className="list-decimal list-inside text-sm space-y-2">
            <li>Abre <a href="https://console.firebase.google.com" target="_blank" rel="noreferrer" className="text-pink-600 underline">console.firebase.google.com</a></li>
            <li>Definições do projeto → As tuas apps → Web</li>
            <li>Copia apiKey, authDomain, projectId, etc. para o <code className="bg-gray-100 px-1 rounded">.env</code></li>
            <li>Reinicia o servidor: <code className="bg-gray-100 px-1 rounded">npm run dev</code></li>
          </ol>
          <Link to="/" className="inline-block text-pink-600 font-semibold">
            Voltar ao site
          </Link>
        </div>
      </main>
