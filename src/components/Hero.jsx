function Hero() {
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto pl-8 w-full grid grid-cols-2 gap-12 items-center relative z-10">
        {/* Conteúdo esquerdo */}
        <div className="space-y-6">
          ...
          >
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
              className="w-4 h-4" style={{ animation: "spinSlow 8s linear infinite" }}>
          ...
          <p className="text-gray-600 text-lg leading-relaxed max-w-md"
            ...
            O Planet She é o teu portal de crescimento profissional.
        ...
        <div className="relative h-screen"
          ...
          <div className="overflow-hidden shadow-2xl h-full">
            <img
              src="https://images.unsplash.com/photo-1633329712165-4e578376eb87?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
