      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-purple-200 text-sm leading-relaxed">
              Cresça, inspire-se e transforme sua vida. Um espaço para
              mulheres que desejam crescer pessoalmente, emocionalmente e
              espiritualmente.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <a
                href="#"
                className="text-purple-200 text-sm hover:text-pink-400 transition block"
              >
        ...
        <div className="border-t border-purple-800 pt-8 text-center">
          <p className="text-purple-300 text-sm">
            © 2026 Planet She. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
